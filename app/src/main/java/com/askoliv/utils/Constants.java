...
public class Constants {
    ...
    public static final String FIREBASE_URL = "https://askoliv.firebaseio.com";
    public static final String FIREBASE_CHAT_NODE = "chat";
    public static final String FIREBASE_HELP_QUESTIONS_NODE = "help_questions";
    public static final String FIREBASE_USER_NODE = "user";
