...
public class StoryPagerAdapter extends PagerAdapter{
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = mActivity.getLayoutInflater().inflate(in.parapluie.app.R.layout.story_pager_item, container, false);

        Log.d(TAG,"Container Child count:"+container.getChildCount());

        if(mResources.get(position)!=null){
            ImageView imageView = (ImageView) itemView.findViewById(in.parapluie.app.R.id.story_pager_image);
            int[] randomBgColors = mActivity.getResources().getIntArray(in.parapluie.app.R.array.random_bg_colors);
            ...
            TextView textView = (TextView) itemView.findViewById(in.parapluie.app.R.id.story_pager_text);
